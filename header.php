        ...
        <div class="header-top-wrp">
            <ul class="info">
                <li><svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#0" class="ms-1">info@futreready.com</a>
                </li>
                <li class="ms-4"><svg width="16" height="15" viewBox="0 0 16 15" fill="none"
                    ...
                    <a href="#0" class="ms-1">+91 80899 19920</a>
                </li>
            </ul>
            <ul class="link-info">
...
<div id="targetElement" class="sidebar-area sidebar__hide">
    ...
    <a href="index.html" class="logo mb-40">
        <img src="assets/images/future/logo-white.webp" alt="logo">
    </a>
    <div class="mobile-menu overflow-hidden"></div>
    <ul class="info pt-40">
        <li><i class="fa-solid primary-color fa-location-dot"></i> <a href="#0">Edapally, Kochi</a>
        </li>
        <li class="py-2"><i class="fa-solid primary-color fa-phone-volume"></i> <a
                href="tel:+91 80899 19920">+91 80899 19920</a>
        </li>
        <li><i class="fa-solid primary-color fa-paper-plane"></i> <a href="#0">info@futureready.com</a></li>
    </ul>
