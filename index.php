        ...
        <section class="banner-area pt-160 pb-160">
            ...
            <div class="container">
                <div class="banner__content">
                    <h3 class="mb-15 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Empowering Future Leaders</h3>
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="section-header mb-20">
                                <h5 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <i class="fa-regular fa-angles-left pe-1"></i> ABOUT US <i class="fa-regular fa-angles-right ps-1"></i>
                                </h5>
                                ...
                                <p class="wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    The Future Ready Foundation is dedicated to bridging the gap between education and industry.
                                    Through expert mentoring, career development programs, and personalized guidance, we empower young talents to become successful, responsible global citizens.
                                </p>
                            </div>
                            ...
                            <div class="about-two__content">
                                <div class="item mb-30 wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>We provide tailored career mapping, expert mentoring to prepare students for the professional world.</p>
                                    </div>
                                </div>
                                ...
                                <div class="item wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Our programs focus on mental and physical well-being, equipping students with the skills to succeed in all areas of life.</p>
                                    </div>
                                </div>

                                <div class="d-flex align-content-center flex-wrap gap-4 mt-40 wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    <div class="btn-two">
                                        <span class="btn-circle"></span>
                                        <a href="#!" class="btn-inner">
                ...
                <div class="owl-carousel owl-theme mentors">
                    ...
                    <div class="items">
                        <div class="cause__item text-center">
                            ...
                            <div class="cause__content">
                                <h4 class="mt-20"><a href="#!" class="primary-hover">Flight Lieutenant A T Kishore</a></h4>
                                <div class="progress-area ">
                    ...
                    <div class="col-md-6 wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="project__item">
                            ...
                            <div class="project__content">
                                <div class="con">
                                    <h4><a href="#!" class="text-white">Institution Improvement - University / College / Schools</a></h4>
                                </div>
        ...
        <section class="blog-area pb-120">
            <div class="container">
                <div class="section-header mb-60 text-center">
                    ...
                    <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Training / Knowledge Partners</h2>
                </div>
                <div class="owl-carousel owl-theme colleges">
                    <div class="item">
                        <div class="blog__item">
                            ...
                            <div class="blog__content pt-4">
                                ...
                                <h4 class="pb-25 bor-bottom"><a href="#!"
                                        class="primary-hover">Bravee MultiSkilling Academy</a></h4>
                                ...
                                <a class="mt-4" href="#!"><span class="read-more fw-bold transition">View Details <i class="fa-solid fa-arrow-right ms-1"></i></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="blog__item">
                            ...
                            <div class="blog__content pt-4">
                                ...
                                <h4 class="pb-25 bor-bottom"><a href="#!"
                                        class="primary-hover">Shivaayu Aerospace</a></h4>
                                <div class="row justify-content-between">
                                    <li class="col-lg-6">
                                        50K+ Students
                                    </li>
                    ...
                    <div class="item">
                        <div class="blog__item">
                            <div class="image">
                                <img src="assets/images/future/college/3.webp" alt="image">

                            </div>
                            <div class="blog__content pt-4">

                                <h4 class="pb-25 bor-bottom"><a href="#!"
                                        class="primary-hover">Avishkara School for Applied Professional Training
                                    </a></h4>
                                <div class="row justify-content-between">
                                    <li class="col-lg-6">
                                        50K+ Students
                    ...
                    <div class="item">
                        <div class="blog__item">
                            ...
                            <div class="blog__content pt-4">
                                ...
                                <h4 class="pb-25 bor-bottom"><a href="#!"
                                        class="primary-hover">Expertzlab</a></h4>
                                <div class="row justify-content-between">
                                    <li class="col-lg-6">
                                        50K+ Students
                                    </li>
                    ...
                    <div class="item">
                        <div class="blog__item">
                            ...
                            <div class="blog__content pt-4">
                                ...
                                <h4 class="pb-25 bor-bottom"><a href="#!"
                                        class="primary-hover">Eduten Finland</a></h4>
                                <div class="row justify-content-between">
                                    <li class="col-lg-6">
                                        50K+ Students
                                    </li>
                ...
                <div class="col-xl-6">
                    <div class="donate__item">
                        <div class="section-header mb-40">
                            ...
                            <h2 class="text-white wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Join Our Future Making Journey Today</h2>
                        </div>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ex repellendus consequatur exercitationem similique error, ducimus pariatur nobis, neque beatae unde iusto, facere non veritatis. Ex modi dolor dolorum cumque quasi.</p>
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item wow fadeInDown shadow border-none" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <p>Our mission is to bridge the gap between education and industry by providing expert mentoring, skill development, and career guidance to prepare students for success in their personal and professional lives.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInDown shadow border-none" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <p>We offer personalized mentoring, industry-specific workshops, career mapping, internships, and hands-on experience to help students develop both professional skills and personal growth.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInDown shadow border-none" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <p>Our mentors include industry professionals, life coaches, and domain experts who bring their experience and insights to guide students through tailored programs and hands-on learning opportunities.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item wow fadeInDown shadow border-none" data-wow-delay="600ms" data-wow-duration="1500ms">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <p>We offer programs focusing on student empowerment, teacher transformation, career mapping, soft skills development, health and wellness, and industry projects, all designed to help students become future-ready global citizens.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
